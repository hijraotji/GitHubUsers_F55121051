package com.hijraotji.githubusers_f55121051;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List Github of Users");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "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");
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    user = listUser;
                    adapter = new UseAdapter(MainActivity.this);
